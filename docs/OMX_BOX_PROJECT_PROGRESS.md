...
- RViz2
- HD USB 웹캠
- 프로젝트 작업공간: `/home/itec/omx_box_project_ws`
- 컨테이너 작업공간: `/root/omx_box_project_ws`
...
- 프로젝트만 `/root/omx_box_project_ws`로 마운트
...
```bash
rviz2 -d \
  /root/omx_box_project_ws/install/omx_box_control/share/omx_box_control/rviz/omx_box_project.rviz
```
