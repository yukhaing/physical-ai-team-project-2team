...
class CameraHomographyTarget(Node):
    def __init__(self):
        ...
        self.declare_parameter('robot_target_topic', '/console/robot_target')
        ...
        self.robot_target_pub = self.create_publisher(
            String, str(self.get_parameter('robot_target_topic').value), 10)
    ...
    def pixel_selection_callback(self, message):
