...
GUI_WORKSPACE="${ROOT_WORKSPACE}/omx"
BEAGLE_WORKSPACE="${ROOT_WORKSPACE}/Beagle_Lidar_and_AStar"
...
BEAGLE_PYTHON="${ROOT_WORKSPACE}/Beagle_mobile_robot/.venv/bin/python"
BEAGLE_MISSION="${BEAGLE_WORKSPACE}/scripts/10_shuttle_mission.py"
LOG_DIR="${ROOT_WORKSPACE}/runtime/logs"
...
start_system() {
  ...
  new_window movej "ros2 launch cyclo_motion_controller_ros omx_controller.launch.py controller_type:=movej start_interactive_marker:=false config_file:=${ROOT_WORKSPACE}/omx/docker/config/omx_config_physical.yaml"
